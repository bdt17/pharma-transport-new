class PdfController < ApplicationController
  def chain_of_custody
    ...
    # REAL DB - uses your existing columns
    ...
    # PRAWN (Render will install gem)
    pdf_content = generate_pdf_content(@shipment)
  ...
  def generate_pdf_content(shipment)
    require 'prawn'  # Render auto-installs from Gemfile
